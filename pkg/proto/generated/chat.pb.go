...
var file_chat_proto_rawDesc = []byte{
	...
	0x67, 0x72, 0x70, 0x63, 0x2d, 0x63, 0x68, 0x61, 0x74, 0x2d, 0x66, 0x72, 0x6f, 0x6e, 0x74, 0x65,
	0x6e, 0x64, 0x2d, 0x77, 0x65, 0x62, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_chat_proto_depIdxs = []int32{
	0, // 0: com.pojtinger.felix.goAppGrpcChat.ChatService.TransceiveMessages:input_type -> com.pojtinger.felix.goAppGrpcChat.ChatMessage
	0, // 1: com.pojtinger.felix.goAppGrpcChat.ChatService.TransceiveMessages:output_type -> com.pojtinger.felix.goAppGrpcChat.ChatMessage
...
func (c *chatServiceClient) TransceiveMessages(ctx context.Context, opts ...grpc.CallOption) (ChatService_TransceiveMessagesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ChatService_serviceDesc.Streams[0], "/com.pojtinger.felix.goAppGrpcChat.ChatService/TransceiveMessages", opts...)
	if err != nil {
		return nil, err
	}
